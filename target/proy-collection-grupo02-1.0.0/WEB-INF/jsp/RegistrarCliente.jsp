						...
						<div class="row">
							...
							<div class="section">
							 ...
							 <h2>Datos Personales</h2>
								...
								<form:form method="post" action="createClient.htm" commandName="cliente">
								  <table class="form">
									<tbody>
									<tr>
									  <td><span class="required">*</span> <spring:message code="label.firstname"/>:</td>
									  <td><form:input path="firstname"  />
										<font color="red">  <form:errors path="firstname"/></font>
									  </td>
									</tr>
									<tr>
									  <td><span class="required">*</span> <spring:message code="label.lastname"/>:</td>
									  <td><form:input path="lastname"  />
									 	<font color="red"> <form:errors path="lastname"/></font>
									  </td>
									</tr>
									<tr>
									  <td><span class="required">*</span> <spring:message code="label.email"/>:</td>
									  <td><form:input path="email"  />
									  	<font color="red"><form:errors path="email"/></font>
									  </td>
									</tr>
									<tr>
									  <td><span class="required">*</span> <spring:message code="label.telephone"/>:</td>
									  <td><form:input path="telephone" />
									 	<font color="red"> <form:errors path="telephone"/></font>
									  </td>
									</tr>
									<tr>
									  <td><span class="required">*</span> <spring:message code="label.dni"/>:</td>
									  <td><form:input path="dni" />
											<font color="red"><form:errors path="dni"/> </font>
										</td>
									</tr>							
